...
import { signupRequest, clearError } from '../redux/actions/authActions';
...
const SignupPage = () => {
  ...
  useEffect(() => {
    if (signupDone && !loading && !error) {
      navigate('/login');
    }
  }, [signupDone, loading, error, navigate]);
  ...
  return (
    ...
    >
      <Card style={{ width: 480, boxShadow: '0 4px 12px rgba(0,0,0,0.1)' }}>
